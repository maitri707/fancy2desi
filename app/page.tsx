...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-[#fcfdfa] font-sans pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 relative z-10">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#f0f4e8] text-[#6f913d] mb-6 shadow-sm">
            <UtensilsCrossed size={32} />
          </div>
          <h1 className="text-4xl font-black text-[#34482a] tracking-tight mb-3">
            Fancy Menu <span className="text-[#6f913d]">→</span> Desi Menu
          </h1>
